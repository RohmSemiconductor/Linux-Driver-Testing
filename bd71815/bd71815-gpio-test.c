...
static struct of_device_id bd71815_of_match[] = {
	{
		.compatible = "rohm,foo-bd71815-gpio",
	},
	{ },
};
MODULE_DEVICE_TABLE(of, bd71815_of_match);

struct platform_driver bd71815_gpio_consumer = {
        .driver = {
                .name = "bd71815-gpio-test",
		.of_match_table = bd71815_of_match,
        },
        .probe = bd71815_gpio_probe,
	.remove = bd71815_gpio_remove,
};

module_platform_driver(bd71815_gpio_consumer);

MODULE_AUTHOR("Matti Vaittinen <matti.vaittinen@fi.rohmeurope.com>");
MODULE_DESCRIPTION("BD71815 gpio test driver");
MODULE_LICENSE("GPL");
